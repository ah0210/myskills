# PowerShell Virtual Environment Setup Script for WebParser

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "WebParser Virtual Environment Setup" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "2. Run examples: python examples\basic_usage.py" -ForegroundColor White
